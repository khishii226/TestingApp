...
const Island = forwardRef((props, ref) => {
  ...
  const singlePlayAnimations = useRef(['Action.008', 'Action.009', 'Action.002', 'Action.016']);
      ...
      if (child.isMesh) {
        ...
        if (child.name === 'Ground005') {
          ...
          const glassNames = [
            ...
            'Icosphere', 'CoffeeTable001',
            'Cube217', 'Cube219', 'Cube218', 'Cube003',
            'Cube001', 'Cube004', 'Cube005', 'Cube006', 'TransparentWall001', 'Wall_plain002',
          ];
